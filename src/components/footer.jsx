    ...
    <div className='container m-auto flex flex-col gap-22 py-10'>
      <div className='flex gap-26 justify-center items-start'>
        ...
        <div className='flex flex-col'>
          ...
          <a className='text-[#BBB3B36E] text-xl' href="">Buy</a>
          <a className='text-[#BBB3B36E] text-xl' href="">More</a>
        </div>
        <div className='flex flex-col'>
          <h4 className='text-[#BBB3B3] text-xl'>We make</h4>
          <a className='text-[#BBB3B36E] text-xl' href="">Process</a>
        </div>
        <div className='flex flex-col'>
          <h4 className='text-[#BBB3B3] text-xl'>Products</h4>
          <a className='text-[#BBB3B36E] text-xl' href="">Cappuccino</a>
          <a className='text-[#BBB3B36E] text-xl' href="">Fast</a>
          <a className='text-[#BBB3B36E] text-xl' href="">Fast</a>
        </div>
        <div className='flex flex-col'>
          <h4 className='text-[#BBB3B3] text-xl'>Events</h4>
          <a className='text-[#BBB3B36E] text-xl' href="">Drinks</a>
          <a className='text-[#BBB3B36E] text-xl' href="">Eat</a>
        </div>
        <div className='flex flex-col'>
        ...
        <img className='h-[84px] w-[84px]' src="src/assets/top.png" alt="" />
      </div>
